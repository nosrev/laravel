    ...
    <body>
      ...
      <div>
        <div class="container mx-auto mt-8">
          ...
          <h1 class="text-2xl text-center font-bold mt-6 mb-8">Editar Empréstimo</h1>

          <div class="relative overflow-x-auto max-w-xl mx-auto">
            <form class="bg-white rounded px-8 pt-6 pb-8 mb-4" method="POST" action="{{ route('loans.update', ['id' => $loan->id]) }}">
              @csrf
              <div class="mb-4">
              ...
              <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="return_date" type="date" required value="{{ date('Y-m-d', strtotime($loan->return_date)) }}">
              </div>
